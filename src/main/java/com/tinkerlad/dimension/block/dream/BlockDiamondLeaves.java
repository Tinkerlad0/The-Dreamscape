...
public class BlockDiamondLeaves extends BlockLeavesBase implements IShearable {
	int[]						field_150128_a;
	 ...
	 */
	@SideOnly(Side.CLIENT)
	public void randomDisplayTick(World par1world, int par2int, int par3int, int par4int, Random par5Random) {
		if (par1world.canLightningStrikeAt(par2int, par3int + 1, par4int) && !World.doesBlockHaveSolidTopSurface(par1world, par2int, par3int - 1, par4int)
				&& par5Random.nextInt(15) == 1) {
			double d0 = (double) ((float) par2int + par5Random.nextFloat());
			double d1 = (double) par3int - 0.05D;
			double d2 = (double) ((float) par4int + par5Random.nextFloat());
