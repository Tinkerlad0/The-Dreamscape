...
public class Vector3 {
	...
	public Vector3 normalize() {
		...
		return sqrt < 1.0E-4D ? new Vector3(0.0D, 0.0D, 0.0D) : new Vector3(this.x / sqrt, this.y / sqrt, this.z / sqrt);
	}
	...
	public Vector3 crossProduct(Vector3 vec) {
		return new Vector3(y * vec.z - z * vec.y, z * vec.x - x * vec.z, y * vec.x - x * vec.y);
	}
